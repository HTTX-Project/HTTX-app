<template>
    ...
    <view>
        <view style="padding: 0px 0px;">
            <view :key="index" class="filter-content" v-for="(item, index) in menuList" v-if="menuIndex == index">
                <view v-if="item.isDates">
                    <view class="uni-list">
                        <view class="uni-list-cell">
                            ...
                            <view class="uni-list-cell-db">
                                <picker :end="endDate" :start="startDate" :value="date" @change="bindDateChange" id="p"
                                        mode="date"
                                        ref="p">
                    ...
                    <view class="filter-content-footer">
                        <view @tap="resetClick(selectDetailList,item.key)" class="filter-content-footer-item"
                              style="color: #777777; background-color: #FFFFFF;">
                            <text>重置</text>
                        </view>
                        <view :style="{'color': '#FFFFFF', 'background-color': themeColor}"
                              @tap="sureClick" class="filter-content-footer-item">
                            <text>确定</text>
                        </view>
                    </view>
                </view>
                <view v-else>
                    <view v-if="item.isSort">
                        <view class="filter-content-list">
                            <view :class="detailItem.isSelected?'filter-content-list-item-active':'filter-content-list-item-default'"
                                  :key="idx"
