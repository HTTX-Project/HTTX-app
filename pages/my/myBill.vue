...
export default {
  ...
  methods: {
    ...
    getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
      ...
      const self = this
      const url = `/moneyImpl/moneyChangeList?USER_ID=${self.user.USER_ID}&MONEY_TYPE=${self.MONEY_TYPE}&REASON_TYPE=${self.REASON_TYPE}&JJB_TYPE=&START_TIME=${self.date}&page=${pageNum}`
